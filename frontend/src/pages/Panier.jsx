    ...
    return (
      <div className="min-h-screen bg-cream flex items-center justify-center px-4">
        <div className="text-center">
          ...
          <p className="text-gray-500 mb-7">Explorez notre catalogue pour ajouter des produits.</p>
          <Link to="/" className="inline-block px-6 py-3 bg-primary text-white font-semibold rounded-xl hover:bg-primary-dark transition">
            Retour au catalogue
          </Link>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-4">
            {items.map((item) => (
              <div key={item.product.id} className="bg-white rounded-2xl shadow-sm p-5 flex gap-4">
                {/* Image */}
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-sm text-gray-400 mt-0.5">{formatPrice(item.product.price)} / unité</p>
