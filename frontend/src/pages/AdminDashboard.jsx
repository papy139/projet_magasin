...
export default function AdminDashboard() {
  ...
  const {
    ...
    sortKey: pSortKey,
    sortDir: pSortDir,
    toggleSort: togglePSort,
    resetFilters: resetPFilters,
  ...
  const {
    ...
    sortKey: oSortKey,
    sortDir: oSortDir,
    toggleSort: toggleOSort,
    resetFilters: resetOFilters,
      ...
      <div className="max-w-7xl mx-auto px-4 py-8 space-y-6">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
          ...
          <StatCard
            label="Ruptures"
            value={outOfStock}
            color={outOfStock > 0 ? "text-red-500" : "text-gray-900"}
            sub="stocks à zéro"
          />
          ...
          <StatCard
            label="En attente"
            value={pendingOrders}
            color={pendingOrders > 0 ? "text-amber-500" : "text-gray-900"}
            sub="à traiter"
          />
        </div>
          ...
          <section className="space-y-4">
            ...
            <div className="bg-white rounded-2xl shadow-sm p-4 flex flex-wrap gap-3 items-center">
              ...
              <select
                ...
                className="border border-gray-200 rounded-xl px-3 py-2 text-sm focus:outline-none appearance-none bg-white"
              >
              ...
              <input
                ...
                className="border border-gray-200 rounded-xl px-3 py-2 text-sm w-24 focus:outline-none"
              />
              <input
                type="number"
                        ...
                        {editingStockId === product.id ? (
                          <div className="flex items-center gap-2">
                            ...
                            <button
                              ...
                              className="text-xs bg-primary hover:bg-primary-dark text-white px-2.5 py-1.5 rounded-lg disabled:opacity-50"
                            >
                              OK
                            </button>
                            <button
                              onClick={() => setEditingStockId(null)}
                              aria-label="Annuler la modification du stock"
                        ...
                        {deleteConfirmId === product.id ? (
                          <div className="flex items-center gap-2">
                            ...
                            <button
                              ...
                              className="text-xs bg-red-500 hover:bg-red-600 text-white px-2.5 py-1.5 rounded-lg transition"
                            >
                              Oui
                            </button>
                            <button
